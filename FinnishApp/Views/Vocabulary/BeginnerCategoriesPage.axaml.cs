...
{
    public partial class BeginnerCategoriesPage : UserControl
    {
        public event Action? BackClicked;
        public event Action<string>? CategoryClicked;

        // Definicja grup i podkategorii
        ...
        public BeginnerCategoriesPage()
        {
            InitializeComponent();

            // Cofnij
            this.GetControl<Button>("BackButton")
                .Click += (_, __) => BackClicked?.Invoke();

            // Wypełniamy panel
            var panel = this.GetControl<StackPanel>("ItemsPanel");
